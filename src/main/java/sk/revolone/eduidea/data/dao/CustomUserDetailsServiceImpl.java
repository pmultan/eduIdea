...
import sk.revolone.eduidea.exception.UserNotActivated;
...
public class CustomUserDetailsServiceImpl implements UserDetailsService {
	...
	public UserDetails loadUserByUsername(String username)
		...
		try {
			sk.revolone.eduidea.data.entity.User domainUser = userRepository
					.findByUsernameOrEmail(username, username);
			if (!domainUser.getIsActivated())
				throw new UserNotActivated(" - Username : "
						+ domainUser.getUsername() + ", Email: "
						+ domainUser.getEmail());
			...
			UserLogged user = new UserLogged(domainUser.getUsername(),
